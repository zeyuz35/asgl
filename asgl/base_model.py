...
class BaseModel(BaseEstimator, RegressorMixin):
    ...
    def fit(
        ...
        group_index: Optional[Sequence[int]], default=None
    ...
    def score(self, X, y, sample_weight=None):
        """
        Return the coefficient of determination R^2 of the prediction or accuracy.
        ...
        -------
        score: float
            R^2 of self.predict(X) wrt. y or accuracy.
        """
